"""Intuitive-K-prototypes replication sandbox.
...
traceability over speed because this folder is a paper-replication sandbox.
"""
...
class IntuitiveKPrototypes:
    ...
    def fit(
        ...
        prototype_idx = select_initial_prototypes(
            X_num_arr,
            X_cat_arr,
