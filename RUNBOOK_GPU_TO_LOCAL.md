...
`src/representation_learning/MVDEC_dense.py`. The checked-in Tiki artifact can
still be used for local experiments when retraining is unnecessary.
...
final_training_objective == "mvdec2025_latent_joint_reconstruction_greedy_l3_trace_logged"
```
