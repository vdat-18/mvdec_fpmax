...
from pipeline.forward_selection import (
    DEFAULT_FFS_MIN_IMPROVEMENT,
    improves_score,
...
def run_without_ffs_intuitive_view_weighted_native(
    ...
    *,
    ...
    return run_experiment_grid(
        ...
        job_runner=partial(
            run_without_ffs_intuitive_view_weighted_native_job,
            intuitive_param_grid=intuitive_param_grid,
            two_stage=two_stage,
            init_strategy=init_strategy,
            strict_init=strict_init,
    ...
    *,
    ...
    while remaining:
        ...
        if (
            ...
            or not improves_score(local_best_score, best_score, min_improvement)
        ):
            break
...
def run_without_ffs_intuitive_view_weighted_native_job(
    ...
    selection = select_native_intuitive_trials(
        ...
        param_workers=param_workers,
        intuitive_param_grid=(
            intuitive_param_grid or default_view_weighted_intuitive_param_grid()
        ),
        two_stage=two_stage,
        init_strategy=init_strategy,
        strict_init=strict_init,
